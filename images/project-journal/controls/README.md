...
- `back.svg` (24 × 24): green raised disk and left arrow.
...
- `close.svg` (12 × 12): stepped cross.

Only `select-arrow.svg` is used by the journal. The Back, Home, Favorites, and Close assets remain as dormant source artwork; the shared browser header uses its common artwork and styling.
